  ...
  funcao inicio() {
    ...
    cadeia empresa =  "Exemplo Ltda."
    cadeia cnpj =  "12.345.678/0001-99"
    cadeia rua =  "Rua das flores"
    cadeia numero =  "123"
    cadeia bairro =  "Centro"
    cadeia estado =  "PI"
    cadeia cidade =  "Água Branca"
    cadeia telefone =  "(86) 1234-5678"
    cadeia email =  "contato@empresaexemplo.com.br"
    inteiro dia = 31
    inteiro mes = 5
    inteiro ano = 2025
